...
contract Ballot {
    ...
    address public ballotOfficialAddress; // address of this ballot
    string public ballotOfficialName; 
    string public proposal; // this is actual proposal

    mapping(uint => vote) private votes;
    mapping(address => voter) public voterRegister;

    enum State { Created, Voting, Ended}
    State public state; // this track state of voting 
